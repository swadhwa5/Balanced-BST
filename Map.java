 ...
 *
 * <p>Keys must be unique, not null, and should be immutable; values have
 ...
 * to show you yet another style of interface design.</p>
 *
 * <p>Maps are a <b>very</b> popular abstraction. Some languages, Go and
 * Python for example, have them "built in" already. Maps are also
 * known as "dictionaries" or "associative arrays" in other contexts.</p>
 *
